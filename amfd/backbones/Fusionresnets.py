...
class FusionResNet(BaseModule):
    ...
    def _fusion_layer_stem(self,in_channels,stem_channels):
        ...
        # self.fusion_conv1 = build_conv_layer(
        #         self.conv_cfg,
        #         in_channels*2,
        #         stem_channels,
        #         kernel_size=7,
        ...
        # with torch.no_grad():
        #     self.fusion_conv1.weight[:, :3, :, :] = copy.deepcopy(self.conv1).weight / 2
        #     self.fusion_conv1.weight[:, 3:, :, :] = copy.deepcopy(self.conv1).weight / 2
        
        # # self.conv1 = fusion_conv1

        # self.add_module('fusion_conv1', self.fusion_conv1)
        self.fusion_layers=[]
    ...
    def forward(self, x):
        ...
        # fusion_conv1 = getattr(self,'fusion_conv1')
